...
Ranger is a terminal based file browser to browse, move, copy, edit, delete files.
It allows VIM-like key bindings to move left/down/up/right (h/j/k/l)
This config is forked from
...
# References
- [luke YouTube video](https://youtu.be/nlolvAVqn10)
- [Luke Smith's GitHub](https://github.com/LukeSmithxyz/voidrice.git)
